// Ubicación: /components/layout/HeaderLead.tsx
// Header específico para líderes de proyecto
        ...
        <div className="flex items-center space-x-6">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-xs text-muted -mt-1">Líder de Proyecto</p>
            </div>
          </div>

          {/* Navegación principal completa */}
          <nav className="hidden lg:flex items-center space-x-1">
            <ActiveLink href="/lead/dashboard" className="nav-link px-3 py-2 rounded-lg text-sm">
              <BarChart3 className="w-4 h-4 inline mr-2" />
              Dashboard
            </ActiveLink>
            <ActiveLink href="/lead/users" className="nav-link px-3 py-2 rounded-lg text-sm">
              <Users className="w-4 h-4 inline mr-2" />
              Usuarios
            </ActiveLink>
            <ActiveLink href="/lead/projects" className="nav-link px-3 py-2 rounded-lg text-sm">
              <FolderOpen className="w-4 h-4 inline mr-2" />
              Proyectos
            </ActiveLink>
            <ActiveLink href="/lead/communications" className="nav-link px-3 py-2 rounded-lg text-sm">
              <MessageSquare className="w-4 h-4 inline mr-2" />
              Comunicaciones
            </ActiveLink>
            <ActiveLink href="/lead/documents" className="nav-link px-3 py-2 rounded-lg text-sm">
              <FileText className="w-4 h-4 inline mr-2" />
              Documentos
            </ActiveLink>
            <ActiveLink href="/lead/evaluations" className="nav-link px-3 py-2 rounded-lg text-sm">
              <ClipboardList className="w-4 h-4 inline mr-2" />
              Evaluaciones
            </ActiveLink>
            <ActiveLink href="/lead/recruitment" className="nav-link px-3 py-2 rounded-lg text-sm">
              <UserPlus className="w-4 h-4 inline mr-2" />
              Reclutamiento
            </ActiveLink>
            <ActiveLink href="/lead/settings" className="nav-link px-3 py-2 rounded-lg text-sm">
              ...
              <div className="absolute right-0 top-11 w-80 card p-4 space-y-3 z-50">
                ...
                <div className="space-y-2">
                  <div className="p-3 bg-blue-50 rounded-lg border-l-4 border-blue-400">
                    <p className="text-sm font-medium text-blue-800">Nueva tarea asignada</p>
                    <p className="text-xs text-blue-600">Revisión de presupuesto Q4</p>
                  </div>
                  <div className="p-3 bg-yellow-50 rounded-lg border-l-4 border-yellow-400">
                    <p className="text-sm font-medium text-yellow-800">Milestone próximo</p>
                    <p className="text-xs text-yellow-600">Entrega proyecto EcoVerde mañana</p>
                  </div>
                  <div className="p-3 bg-green-50 rounded-lg border-l-4 border-green-400">
                    <p className="text-sm font-medium text-green-800">Proyecto completado</p>
                    <p className="text-xs text-green-600">CleanUp 2024 finalizado exitosamente</p>
                  </div>
                </div>
          ...
          <div className="relative">
            ...
            >
              ...
              <div className="hidden md:block text-left">
                <p className="text-sm font-medium text-slate-700">{session?.name || 'Lead'}</p>
                <p className="text-xs text-muted -mt-0.5">Líder de Proyecto</p>
              </div>
