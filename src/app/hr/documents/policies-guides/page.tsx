          ...
          <Card key={doc.id} className="hover:shadow-lg transition-shadow">
            ...
            <CardContent>
              <div className="text-gray-500">
                <p className="mb-2">Tipo: {doc.type}</p>
                <p className="mb-2">Versión: {doc.version}</p>
                <p className="mb-2">Subido por: {doc.uploadedBy}</p>
                <p className="mb-2">Fecha de subida: {doc.uploadDate}</p>
              </div>
              <button
