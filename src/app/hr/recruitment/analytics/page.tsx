...
const tabMap: { [key: string]: string } = {
  'Pipeline de Reclutamiento': '/hr/recruitment/analytics/pipeline',
  'Métricas de Contratación': '/hr/recruitment/analytics/hiring-metrics',
  'Fuente de Candidatos': '/hr/recruitment/analytics/source-analysis',
  'Tendencias Históricas': '/hr/recruitment/analytics/historical-trends',
};
