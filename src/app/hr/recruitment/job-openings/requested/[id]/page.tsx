// src/app/hr/recruitment/job-openings/requested/[id]/page.tsx
'use client';
...
export default function JobOpeningDetailPage() {
  ...
  const handleApprove = () => {
    ...
    router.push('/hr/recruitment/job-openings');
  };
      ...
      <div className="p-8 max-w-6xl mx-auto">
        ...
        <AdminBreadcrumb
          items={[
            ...
            { label: 'Gestión de Vacantes', href: '/hr/recruitment/job-openings' },
            { label: job.title }
          ]}
        />
