...
const evaluationSections = [
  ...
  },
  {
    ...
    description: 'Coordina horarios con reclutadores y candidatos. Envía invitaciones y recordatorios automáticos.',
    href: '/hr/recruitment/evaluation/interview-scheduling',
    icon: CalendarCheck,
