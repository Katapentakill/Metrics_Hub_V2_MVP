// src/app/volunteer/documents/project-resources/page.tsx
import Link from 'next/link';
import { FileText, Briefcase, Link as LinkIcon, Download } from 'lucide-react';
import { Card, CardHeader, CardTitle, CardContent } from '@/components/ui/card';
import { Button } from '@/components/ui/button';

// Datos simulados de los documentos de proyecto del voluntario
  ...
  return (
    <div className="p-8">
      ...
      <p className="text-gray-600 mb-10">
        Accede a los documentos y manuales que te ayudarán a familiarizarte con las herramientas y procedimientos de tu proyecto.
      </p>
