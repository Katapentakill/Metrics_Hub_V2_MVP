...
import { filterEvaluationsForVolunteer, getCurrentUserId } from '@/lib/utils/evaluationFilters';
import type { EvaluationMetrics, PerformanceInsight } from '@/lib/types/evaluations';

export default function VolunteerEvaluationsPage() {
  ...
  useEffect(() => {
    ...
    // Filtrar datos para el volunteer
    const filtered = filterEvaluationsForVolunteer(
      allEvaluations,
      extendedMockUsers,
      allMetrics,
