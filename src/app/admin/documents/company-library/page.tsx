...
// src/modules/documents/admin/company-library/page.tsx
'use client';
...
export default function CompanyLibrary() {
  ...
  // Filtrar documentos de tipo General o Legal
  const documents = mockDocuments.filter(
    (doc) =>
      (doc.type === 'general' || doc.type === 'legal') &&
      doc.name.toLowerCase().includes(searchTerm.toLowerCase())
  );

  return (
    <div className="p-8">
      <h1 className="text-3xl font-bold mb-6">📘 Company Library</h1>
      <p className="text-gray-600 mb-6">
        Aquí puedes acceder a todos los documentos generales y legales de la organización.
      </p>
