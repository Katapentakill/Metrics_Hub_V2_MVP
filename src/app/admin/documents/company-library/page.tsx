...
// ============================================================================
// TABS CONFIGURATION - Tonos Verdes
// ============================================================================
...
const getFileIcon = (type: Document['type'], size: 'sm' | 'md' = 'md') => {
  ...
  switch (type) {
    ...
    case 'pptx':
      return <Presentation className={`${iconClass} text-lime-600`} />;
    case 'image':
  ...
  <div className="bg-white rounded-lg border border-gray-200 hover:shadow-lg transition-all duration-300 overflow-hidden group">
    ...
    <div className="p-4 bg-gray-50 border-t border-gray-100 flex gap-2">
      <button
        ...
        className="flex-1 px-3 py-2 bg-gradient-to-r from-emerald-500 to-emerald-600 text-white text-sm rounded-lg hover:shadow-md transition-all flex items-center justify-center gap-2"
      >
      ...
      <div className="flex-1 min-w-0">
        <div className="flex items-start justify-between gap-4">
          <div className="flex-1">
            <h3 className="font-semibold text-gray-900 mb-1 hover:text-emerald-600 transition-colors cursor-pointer">
              {doc.name}
            </h3>
            {doc.description && (
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              onClick={() => onDownload(doc.id)}
              className="px-4 py-2 bg-gradient-to-r from-emerald-500 to-emerald-600 text-white text-sm rounded-lg hover:shadow-md transition-all flex items-center gap-2"
            >
              <Download className="w-4 h-4" />
              Download
            </button>
