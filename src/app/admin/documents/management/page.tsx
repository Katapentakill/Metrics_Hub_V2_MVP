...
const getStatusBadge = (status: ManagedDocument['status']) => {
  const config = {
    ...
    archived: { color: 'bg-gray-100 text-gray-700 border-gray-200', icon: Archive, label: 'Archived' },
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-start justify-between gap-4">
              <div className="flex-1 min-w-0">
                <h3 className="font-semibold text-gray-900 truncate hover:text-emerald-600 transition-colors cursor-pointer">
                  {doc.name}
                </h3>
