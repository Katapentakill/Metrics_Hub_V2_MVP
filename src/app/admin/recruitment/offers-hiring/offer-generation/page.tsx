// src/app/admin/recruitment/offers-hiring/offer-generation/page.tsx
'use client';
    ...
    <AdminPageLayout
      ...
      headerActions={
        <div className="flex gap-3">
          ...
          <a href="/admin/recruitment/offers-hiring/onboarding-management">
            ...
            <div key={candidate.id} className="p-5 border border-slate-200 rounded-lg hover:shadow-md transition-shadow flex items-center justify-between bg-gray-50">
              ...
              <div className="flex gap-2 ml-4 flex-shrink-0">
                ...
                {candidate.status === 'Aceptada' && (
                  <a href={`/admin/recruitment/offers-hiring/onboarding-management?candidate=${candidate.id}`}>
                    <Button 
                      size="sm" 
                      variant="default"
                    >
