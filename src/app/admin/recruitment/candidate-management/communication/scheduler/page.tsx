...
const mockInterviews = [
  ...
  },
  {
    ...
    interviewer: 'David López (RR.HH. Generalista)',
    date: '2025-09-19',
    time: '02:30 PM',
    type: 'RR.HH.',
    status: 'Pendiente',
  ...
  return (
    <div className="p-8">
      <div className="flex justify-between items-center mb-6">
        <h1 className="text-3xl font-bold">Programador de Entrevistas Global (Admin)</h1>
        <Button asChild>
          <Link href="/admin/recruitment/candidate-management/communication/scheduler/new">
      ...
      <p className="text-gray-600 mb-10">
        Como administrador, puedes supervisar y gestionar todas las entrevistas programadas por el equipo de reclutamiento.
      </p>

      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {mockInterviews.map((interview) => (
          <Link key={interview.id} href={`/admin/recruitment/candidate-management/communication/scheduler/${interview.id}`}>
