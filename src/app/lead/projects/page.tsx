// UBICACIÓN: src/app/lead/projects/page.tsx
// Página de proyectos para Líder de Proyecto - Solo ve sus propios proyectos
...
import ExportProjects from '@/modules/projects/lead/ExportProjects';
import { buildProjectViews, ProjectView } from '@/lib/map/projects/projectView';
import AdvancedProjectFilters, { AdvancedProjectFilterOptions } from '@/modules/projects/lead/AdvancedProjectFilters';
import ProjectsDashboard from '@/modules/projects/lead/ProjectsDashboard';
import ProjectsGridView from '@/modules/projects/lead/ProjectsGridView';
import ProjectModalEdit from '@/modules/projects/lead/modals/ProjectModalEdit';
import ProjectDetailModal from '@/modules/projects/lead/modals/ProjectDetailModal';
...
export default function LeadProjectsPage() {
  ...
  // Construir vistas cuando cambien los datos - FILTRADO POR LEAD_ID
  useEffect(() => {
    if (!isLoading && user?.userId) {
      // Filtrar proyectos donde el usuario actual es el líder
      const leadProjects = projects.filter(p => p.lead_id === user.userId);
      const v = buildProjectViews(leadProjects, users, mockTeams, mockTeamMembers);
      setViews(v);
    }
  ...
  // Los líderes NO pueden eliminar proyectos
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
      ...
      <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center space-y-4 lg:space-y-0">
        <div>
          ...
          <p className="text-muted mt-1">
            Gestiona y supervisa tus proyectos asignados
          </p>
        </div>
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4">
          <div className="flex items-center gap-4 flex-1">
            <div className="relative flex-1 max-w-md">
              ...
              <input
                type="text"
                placeholder="Buscar proyectos, ubicación..."
                value={searchTerm}
      ...
      {viewMode === 'dashboard' ? (
        ...
        <div className="space-y-6">
          ...
          <AdvancedProjectFilters 
            ...
            availableLeads={[]} // Los líderes no necesitan filtrar por otros líderes
          />
      ...
      {showEdit && (
        <ProjectModalEdit
          ...
          leads={[]} // Los líderes no pueden cambiar el líder del proyecto
          onSave={onSave}
