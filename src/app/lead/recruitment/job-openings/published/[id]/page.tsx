// src/app/lead/recruitment/job-openings/published/[id]/page.tsx
// src/app/lead/recruitment/job-openings/published/[id]/page.tsx
'use client';
...
import AdminBreadcrumb from '@/modules/recruitment/lead/components/AdminBreadcrumb';
...
export default function PublishedJobDetailPage() {
  ...
  const handleClose = () => {
    ...
    router.push('/lead/recruitment/job-openings');
  };
      ...
      <div className="p-8 max-w-6xl mx-auto">
        ...
        <AdminBreadcrumb
          items={[
            ...
            { label: 'Gestión de Vacantes', href: '/lead/recruitment/job-openings' },
            { label: job.title }
          ]}
        />
