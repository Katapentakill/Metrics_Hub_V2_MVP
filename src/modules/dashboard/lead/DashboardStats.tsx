...
/**
 * Estructura de datos que contiene las métricas principales del dashboard de Lead Project.
 */
interface LeadDashboardData {
    /** Total de proyectos asignados al lead */
    totalProjects: number;
    /** Número de proyectos activos actualmente */
    activeProjects: number;
    /** Número total de miembros en los equipos */
    totalTeamMembers: number;
    /** Tareas activas actualmente */
    activeTasks: number;
    /** Tareas ya completadas */
    completedTasks: number;
    /** Cantidad de entregas atrasadas */
    overdueDeadlines: number;
    /** Número de entregas realizadas en el mes actual */
    thisMonthDeliveries: number;
    /** Puntaje de rendimiento del equipo (ej: 0-100) */
    teamPerformanceScore: number;
}

/**
 * Props que recibe el componente DashboardStats.
 */
interface LeadDashboardStatsProps {
    /** Datos del dashboard; si es null no se renderiza el componente */
    data: LeadDashboardData | null;
}

/**
 * DashboardStats Component (Lead)
 *
 * Muestra métricas y visualizaciones para un usuario con rol **Lead Project**,
 * incluyendo estado de proyectos, productividad de equipos, progreso semanal,
 * distribución de tareas por prioridad y métricas de rendimiento.
 *
 * @component
 * @example
 * <DashboardStats data={leadData} />
 */
export default function DashboardStats({ data }: LeadDashboardStatsProps) {
    if (!data) return null;

    /** Estado de proyectos por categoría */
    ...
    /** Productividad de cada equipo (miembros y porcentaje de completitud) */
    ...
    /** Progreso semanal de tareas asignadas vs completadas */
