...
const sections: SectionConfig[] = [
  ...
  },
  {
    ...
    stats: { label: 'Signed', value: 5, subValue: '0 need review' },
  },
  {
  ...
  },
  {
    ...
    stats: { label: 'Uploads', value: 2, subValue: '0 urgent' },
  },
];

const recentActivities: RecentActivity[] = [
  { id: '1', action: 'uploaded', user: 'Volunteer', document: 'CV.pdf', time: '5 min ago', type: 'upload' },
  { id: '2', action: 'signed', user: 'Admin', document: 'Volunteer Agreement', time: '12 min ago', type: 'approve' },
  { id: '3', action: 'reviewed', user: 'Project Lead', document: 'Project Guidelines', time: '1 hour ago', type: 'review' },
  { id: '4', action: 'downloaded', user: 'Volunteer', document: 'Project Resources', time: '2 hours ago', type: 'download' },
];
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-10">
          <div className="flex items-center gap-4 mb-6">
            ...
            <div>
              <h1 className="text-5xl font-bold text-gray-900 mb-1">Volunteer Document Center</h1>
