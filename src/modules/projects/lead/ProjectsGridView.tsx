// UBICACIÓN: src/modules/projects/lead/ProjectsGridView.tsx
// Vista de grid de proyectos para Líder de Proyecto - Solo muestra sus proyectos
    ...
    <div className="space-y-6">
      ...
      {sortedProjects.length === 0 ? (
        <div className="text-center py-20">
          ...
          <p className="text-gray-500">Contacta con HR para que te asignen proyectos como líder.</p>
        </div>
      ) : (
        <>
          {viewMode === 'grid' ? (
