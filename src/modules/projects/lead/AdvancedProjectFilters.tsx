// Ubicación: src/modules/projects/lead/AdvancedProjectFilters.tsx
// Filtros avanzados para Líder de Proyecto - Sin filtro de líder
      ...
      <div className="px-6 py-4 border-b border-gray-200">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-3">
            ...
            <h3 className="text-lg font-semibold text-gray-800">Filtros de Mis Proyectos</h3>
