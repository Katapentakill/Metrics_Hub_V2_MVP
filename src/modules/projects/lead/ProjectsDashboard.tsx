// UBICACIÓN: src/modules/projects/lead/ProjectsDashboard.tsx
// Dashboard de proyectos para Líder de Proyecto - Solo muestra sus proyectos
// ✅ FIX: Agregado onChange handler al select (línea 131)
...
export default function ProjectsDashboard({ 
  ...
  const navigateToProject = (projectId: string) => {
    router.push(`/lead/projects/${projectId}`);
  };
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-2xl font-bold text-gray-800">Panel de Mis Proyectos</h2>
          <p className="text-gray-600">Resumen y métricas de tus proyectos asignados</p>
        </div>
        ...
        <div className="p-6">
          {activeTab === 'overview' && (
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <h3 className="text-lg font-semibold text-gray-800">Mis Proyectos Destacados</h3>
                  <button 
          ...
          {activeTab === 'performance' && (
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              <div className="lg:col-span-2 space-y-4">
                <h3 className="text-lg font-semibold text-gray-800">Rendimiento de Mis Proyectos</h3>
          ...
          {activeTab === 'team' && (
            <div className="space-y-6">
              <h3 className="text-lg font-semibold text-gray-800">Gestión de Mis Equipos</h3>
              ...
              <div className="bg-gray-50 rounded-lg p-6">
                <h4 className="font-medium text-gray-800 mb-4">Mis Proyectos por Capacidad de Equipo</h4>
                <div className="space-y-3">
          ...
          {activeTab === 'timeline' && (
            <div className="space-y-6">
              <h3 className="text-lg font-semibold text-gray-800">Cronograma de Mis Proyectos</h3>
