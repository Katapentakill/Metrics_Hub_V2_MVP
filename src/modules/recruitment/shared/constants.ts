...
export const STATUS_COLORS: Record<CandidateStatus, string> = {
  ...
  'HR Interview Scheduled': 'bg-yellow-100 text-yellow-700',
  'HR Interview Completed': 'bg-orange-100 text-orange-700',
  'Accepted by HR': 'bg-green-100 text-green-700',
  'PM Interview Scheduled': 'bg-yellow-100 text-yellow-700',
  'PM Interview Completed': 'bg-orange-100 text-orange-700',
