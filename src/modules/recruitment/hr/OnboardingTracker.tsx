...
// Opciones CPT/OPT
const cptOptOptions: CptOptStatus[] = ['No required', 'requested', 'received', 'approved', 'rejected'];
...
export default function OnboardingTracker() {
  ...
  const handleAdd = (candidate: MockCandidate) => {
    console.log(`Candidato ${candidate.name} añadido a la base de datos de voluntarios activos.`);
  };
                                ...
                                <tr>
                                    <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-slate-900">
                                        <div className="flex items-center">
                                            ...
                                            >
                                                {expanded.includes(candidate.id) ? <Minus size={16} /> : <Plus size={16} />}
                                            </button>
                                    ...
                                    <td className="px-6 py-4 whitespace-nowrap text-sm text-slate-500">
                                        <select
                                            ...
                                            onChange={e =>
                                                handleFieldChange(candidate.id, 'applicationStatus', e.target.value as CandidateStatus)
                                            }
                                    ...
                                    <td className="px-6 py-4 whitespace-nowrap text-sm text-slate-500">
                                        <select
                                            ...
                                            onChange={e => handleFieldChange(candidate.id, 'role', e.target.value)}
                                    ...
                                    <td className="px-6 py-4 whitespace-nowrap text-sm text-slate-500">
                                        <select
                                            ...
                                            className={`block w-full px-2 py-1 border rounded-md text-xs font-semibold ${c_optStatusColors[candidate.cptOptStatus]}`}
                                                ...
                                                <div className="space-y-1">
                                                    ...
                                                    <div className="flex items-center space-x-2">
                                                        ...
                                                        <input
                                                            ...
                                                            onChange={e => handleFieldChange(candidate.id, 'cvLink', e.target.value)}
                                                            className="border rounded px-2 py-1 text-sm text-slate-700 w-full"
                                                        />
                                                    </div>
                                                    <div className="flex items-center space-x-2">
                                                        ...
                                                        <input
                                                            ...
                                                            onChange={e =>
                                                                handleFieldChange(candidate.id, 'offerLetterLink', e.target.value)
                                                            }
                                                            className="border rounded px-2 py-1 text-sm text-slate-700 w-full"
                                                        />
                                                    </div>
                                                ...
                                                <div className="space-y-1">
                                                    ...
                                                    <div className="flex items-center space-x-2">
                                                        ...
                                                        <span>
                                                            ...
                                                            {candidate.interviewAssigned ? `(Asignado a: ${candidate.interviewAssigned})` : ''}
                                                        </span>
                                                    </div>
                                                    <div className="flex items-center space-x-2">
                                                        <Calendar size={16} />
                                                        <span>
                                                            ...
                                                            {candidate.supervisor ? `(Supervisor: ${candidate.supervisor})` : ''}
                                                        </span>
                                                    </div>
                                                    <div className="flex items-center space-x-2">
                                                        <Globe size={16} />
